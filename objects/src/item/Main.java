...
//            sortedList = sortStudents(stulist);
...
//            }
            ...
            //Puts all student's GPA into a HashMap
            for(Student s:stulist){
            ...
            for(String s:idList) {
                ...
                if (i == 1) {
                    if (onePriorityList.containsKey(stu.getID())) {
                        ...
                        //System.out.println("Match at Priority 1 with " + stu.getID());
                    }
                } else if (i == 2) {
                    if (twoPriorityList.containsKey(stu.getID())) {
                        ...
                        //System.out.println("Match at Priority 2 with " + stu.getID());
                    }
                } else if (i == 3) {
                    if (threePriorityList.containsKey(stu.getID())) {
                        ...
                        //System.out.println("Match at Priority 3 with " + stu.getID());
                    }
                } else if (i == 4) {
                    if (fourPriorityList.containsKey(stu.getID())) {
                        ...
                        //System.out.println("Match at Priority 4 with " + stu.getID());
                    }
                }
            }
//            System.out.println(onePriorityList);
//            System.out.println(twoPriorityList);
//            System.out.println(threePriorityList);
//            System.out.println(fourPriorityList);


            Set oneSet = onePriorityList.entrySet();
            Set twoSet = twoPriorityList.entrySet();
            Set threeSet = threePriorityList.entrySet();
            Set fourSet = fourPriorityList.entrySet();
...
//    public static ArrayList<String> sortStudents(ArrayList <Student> stulist){
//        HashMap<String, Double> tMap = new HashMap <>();
//        HashMap<String, Student> hMap = new HashMap <>();
//
//        //Puts all student's GPA into a HashMap
