 ...
 *
 * Input: List of Student and Option objects
 * Output: Students are sorted into their Option choice based on priority and GPA
 *
...
public class StudentPlacement {
    ...
    ArrayList<Student> priorityListOne = new ArrayList<>();
    ArrayList<Student> priorityListTwo = new ArrayList<>();
    ArrayList<Student> priorityListThree = new ArrayList<>();
    ArrayList<Student> priorityListFour = new ArrayList<>();
